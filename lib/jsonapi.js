...
var deleteEntity = exports.deleteEntity = function deleteEntity(entity) {
  var _ref10 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      _ref10$onSuccess = _ref10.onSuccess,
      onSuccess = _ref10$onSuccess === undefined ? _utils.noop : _ref10$onSuccess,
      _ref10$onError = _ref10.onError,
      onError = _ref10$onError === undefined ? _utils.noop : _ref10$onError;
...
var requireEntity = exports.requireEntity = function requireEntity(entityType) {
  ...
  var _ref12 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      _ref12$onSuccess = _ref12.onSuccess,
      onSuccess = _ref12$onSuccess === undefined ? _utils.noop : _ref12$onSuccess,
      _ref12$onError = _ref12.onError,
      onError = _ref12$onError === undefined ? _utils.noop : _ref12$onError;
  ...
  return function (dispatch, getState) {
    return new _promise2.default(function (resolve, reject) {
      var state = getState();
      var api = _immutable2.default.Iterable.isIterable(state) ? getState().get('api') : state.api;

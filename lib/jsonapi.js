...
var uploadFile = exports.uploadFile = function uploadFile(file, _ref) {
  ...
  return function (dispatch, getState) {
    ...
    var _ref3 = _immutable2.default.Iterable.isIterable(state) ? state.get('api').endpoint : state.api.endpoint;
...
var createEntity = exports.createEntity = function createEntity(entity) {
  ...
  return function (dispatch, getState) {
    ...
    var _ref5 = _immutable2.default.Iterable.isIterable(state) ? state.get('api').endpoint : state.api.endpoint;

    var apiHost = _ref5.host;
    var apiPath = _ref5.path;
...
var readEndpoint = exports.readEndpoint = function readEndpoint(endpoint) {
  ...
  return function (dispatch, getState) {
    ...
    var _ref7 = _immutable2.default.Iterable.isIterable(state) ? state.get('api').endpoint : state.api.endpoint;

    var apiHost = _ref7.host;
    var apiPath = _ref7.path;
...
var updateEntity = exports.updateEntity = function updateEntity(entity) {
  ...
  return function (dispatch, getState) {
    ...
    var _ref9 = _immutable2.default.Iterable.isIterable(state) ? state.get('api').endpoint : state.api.endpoint;

    var apiHost = _ref9.host;
    var apiPath = _ref9.path;
...
var deleteEntity = exports.deleteEntity = function deleteEntity(entity) {
  ...
  var _ref10$onSuccess = _ref10.onSuccess;
  var onSuccess = _ref10$onSuccess === undefined ? _utils.noop : _ref10$onSuccess;
  var _ref10$onError = _ref10.onError;
  var onError = _ref10$onError === undefined ? _utils.noop : _ref10$onError;
  ...
  return function (dispatch, getState) {
    ...
    var _ref11 = _immutable2.default.Iterable.isIterable(state) ? state.get('api').endpoint : state.api.endpoint;

    var apiHost = _ref11.host;
    var apiPath = _ref11.path;
...
var requireEntity = exports.requireEntity = function requireEntity(entityType) {
  ...
  var _ref12$onSuccess = _ref12.onSuccess;
  var onSuccess = _ref12$onSuccess === undefined ? _utils.noop : _ref12$onSuccess;
  var _ref12$onError = _ref12.onError;
  var onError = _ref12$onError === undefined ? _utils.noop : _ref12$onError;
  ...
  return function (dispatch, getState) {
    return new _promise2.default(function (resolve, reject) {
      var state = getState();
      var api = _immutable2.default.Iterable.isIterable(state) ? state.get('api') : state.api;
...
// Reducers
var reducer = exports.reducer = (0, _reduxActions.handleActions)((_handleActions = {}, (0, _defineProperty3.default)(_handleActions, _constants.API_SET_HEADERS, function (state, _ref13) {
  var headers = _ref13.payload;

  return _immutable2.default.fromJS(state).setIn(['endpoint', 'headers'], headers).toJS();
}), (0, _defineProperty3.default)(_handleActions, _constants.API_SET_HEADER, function (state, _ref14) {
  var header = _ref14.payload;

  return _immutable2.default.fromJS(state).mergeIn(['endpoint', 'headers'], header).toJS();
}), (0, _defineProperty3.default)(_handleActions, _constants.API_SET_ENDPOINT_HOST, function (state, _ref15) {
  var host = _ref15.payload;

  return _immutable2.default.fromJS(state).setIn(['endpoint', 'host'], host).toJS();
}), (0, _defineProperty3.default)(_handleActions, _constants.API_SET_ENDPOINT_PATH, function (state, _ref16) {
  var path = _ref16.payload;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_CREATED, function (rawState, _ref17) {
  var rawEntities = _ref17.payload;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_READ, function (rawState, _ref18) {
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_WILL_UPDATE, function (rawState, _ref19) {
  var entity = _ref19.payload;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_UPDATED, function (rawState, _ref20) {
  var rawEntities = _ref20.payload;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_UPDATE_FAILED, function (rawState, _ref21) {
  var entity = _ref21.payload.entity;
  var type = entity.type;
  var id = entity.id;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_WILL_DELETE, function (rawState, _ref22) {
  var entity = _ref22.payload;
  var type = entity.type;
  var id = entity.id;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_DELETED, function (rawState, _ref23) {
  var rawEntity = _ref23.payload;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_DELETE_FAILED, function (rawState, _ref24) {
  var entity = _ref24.payload.entity;
  var type = entity.type;
  var id = entity.id;
